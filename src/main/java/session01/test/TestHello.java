...
//        System.out.println(hello1.getToday());
        ...
        // Spring: 利用 IoC (Inversion of Control) 技術來建立物件
        // 配置文件: conf(resources)/beans-config.xml
        ...
        System.out.println(hello1 == hello2);   // True, 代表spring預設是單例
        */

        Hello hello1 = ctx.getBean("hello", Hello.class);   // 指定id
        Hello hello2 = ctx.getBean("hello2", Hello.class);   // 指定id
        System.out.println(hello1.getToday());
        System.out.println(hello2.getToday());
