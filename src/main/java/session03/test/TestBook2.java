...
public class TestBook2 {
    public static void main(String[] args) {
        // 使用 Spring
//        ApplicationContext ctx = new ClassPathXmlApplicationContext("book-config.xml"); // xml配置
        ApplicationContext ctx = new AnnotationConfigApplicationContext(BookConfig.class); // java配置
